...
class _WaitingRoomListState extends State<WaitingRoomList> {
  ...
  getListQueueOnService() {
    if (service == 'G. Dokter Gigi') {
      queuesType = DatabaseService().waitingQueuesG;
    } else if (service == 'U. Dokter Umum') {
      queuesType = DatabaseService().waitingQueuesU;
    } else if (service == 'R. Ronsen') {
      queuesType = DatabaseService().waitingQueuesR;
    } else if (service == 'M. Spesialis Mata') {
      queuesType = DatabaseService().waitingQueuesM;
    } else if (service == 'PD. Spesialis Penyakit Dalam') {
      queuesType = DatabaseService().waitingQueuesPD;
    } else {
