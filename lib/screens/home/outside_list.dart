...
import 'package:yu_ngantri_medic_user/screens/home/queue_list.dart';
...
class _OutsideListState extends State<OutsideList> {
  ...
  getListQueueOnService() {
    if (service == 'G. Dokter Gigi') {
      queuesType = DatabaseService().outsideQueuesG;
    } else if (service == 'U. Dokter Umum') {
      queuesType = DatabaseService().outsideQueuesU;
    } else if (service == 'R. Ronsen') {
      queuesType = DatabaseService().outsideQueuesR;
    } else if (service == 'M. Spesialis Mata') {
      queuesType = DatabaseService().outsideQueuesM;
    } else if (service == 'PD. Spesialis Penyakit Dalam') {
      queuesType = DatabaseService().outsideQueuesPD;
    } else {
